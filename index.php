            ...
            <section class="task-panel tasks-widget">
              ...
              <div class="panel-body">
                ...
                <div class=" add-task-row">
                  <a class="btn btn-success btn-sm pull-left" href="form-edit.php">Ajouter un nouveau ticket</a>
                  <a class="btn btn-default btn-sm pull-right" href="todo-list.php">Voir tous les tickets</a>
                </div>
              </div>
            </section>
          </div>
